...
ActiveRecord::Schema[7.0].define(version: 2025_03_25_094001) do
  ...
  create_table "report_mentions", force: :cascade do |t|
    ...
    t.index ["mentioning_report_id", "mentioned_report_id"], name: "index_report_mentions_on_mentioning_and_mentioned", unique: true
